...
| [`capability-bus.md`](capability-bus.md) | **KCB** — Capability-Bus | control — discovery / invoke / subscribe over MCP + A2A | 0.5.3 · 🚧 candidate |
...
- **Status is a lifecycle:** `draft → candidate → ratified`, and the two promotions are gated
  ...
  **All six sit there now** — KINP 0.5.0, KMI 0.3.8, KCB 0.5.3, KCS 0.3.0, KFT 0.7.1 and, since
