...
| [`media-interchange.md`](media-interchange.md) | **KMI** — Media-Interchange | data — media (assets, lineage, OTIO timelines, transforms) | 0.3.7 · 🚧 candidate |
| [`capability-bus.md`](capability-bus.md) | **KCB** — Capability-Bus | control — discovery / invoke / subscribe over MCP + A2A | 0.5.2 · 🚧 candidate |
...
- **Status is a lifecycle:** `draft → candidate → ratified`, and the two promotions are gated
  ...
  **All six sit there now** — KINP 0.5.0, KMI 0.3.7, KCB 0.5.2, KCS 0.3.0, KFT 0.7.1 and, since
