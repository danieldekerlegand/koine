...
| [`capability-bus.md`](capability-bus.md) | **KCB** — Capability-Bus | control — discovery / invoke / subscribe over MCP + A2A | 0.4.4 · 🚧 candidate |
...
- **Status is a lifecycle:** `draft → candidate → ratified`, and the two promotions are gated
  ...
  Four sit there now — KGP 0.5.2, KMI 0.3.2, KCB 0.4.4, KFT 0.5.0 — each for its own reason; which
