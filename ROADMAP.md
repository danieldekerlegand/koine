...
- **Nothing was recorded back into koine** — ✅ **closed 2026-08-26** by
  `84-record-the-downstream-results`. All **ten** scenarios now carry a populated
  `## Downstream results` section (the tenth records that it was never encoded and never run), the
  run's breaks are opened as findings **DR-1…DR-11** indexed at
  [`scenarios/README.md`](scenarios/README.md#findings-from-the-run-dr-1dr-11), and the same pass
  flipped the stale `planned`-nine **KCS encoding** column in
  [`scenarios/README.md`](scenarios/README.md#the-kcs-encodings-nine-of-ten-exist-and-the-tenth-is-the-ratification-tail).
