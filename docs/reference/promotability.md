...
5. **KINP — the real work is done, and it moved KINP up this list in substance if not in rank.**
   ...
   **unowned**.
6. **KCB — the most work, and the most implemented.** **Five** independent counts as of 0.4.9, one
   fold outstanding (V-2/V-4/V-5/V-7 → 0.5.0) now that MA-6/MA-8/MA-9 landed at 0.4.9, three re-runs
   of folded text, a re-run outstanding since 2026-07-22, and
   the two newest counts — §4.2 backpressure and §4.3 autonomy posture — which, alone among the
   five, also lack a KCS encoding (**DR-12**, **DR-13**); §4.3 additionally carries
...
[`85`](../../tasks/chief/85-fold-the-federation-breaks.json) landed on 2026-08-26.
