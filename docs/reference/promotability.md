...
| 5 | KMI | **3 folds ≈ 2 edits** (MA-13, KMI-only and queued; MA-17 + MA-18, one **KCB** §4.5(a) edit) + 1 re-run | DR-4, DR-8/DR-7 · **plus all of KCB count (i)** | Cost went **up** twice, then **sideways** on 2026-09-12 (MA-12 folded, MA-17/MA-18 in its place) |
...
- **Rows 5 and 6 are now coupled, and that is new.** KMI's remainder **strictly contains** KCB count
  ...
  count (i) now waits on a **KCB** edit for the second time. Its only remaining koine-side item of its
  own is MA-13.
